...
$(function () {
    ...
    //START SHOWN -------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        //SHOW EMPLOYEE LIST
        $('#modalPODVertical').on('shown.bs.modal', function (e) {
            
            const U_BookingNumber = $('.content-row-selected-pod').find('[name="U_BookingNumber"]').val();
            alert(U_BookingNumber)
    ...
    function InitializeTblContentsDatatable(){
        if ($.fn.dataTable.isDataTable('#tblContents')) {
        // Do something else since the dataTable's already initialized
        ...
        setTimeout(function() { 
            ...
            "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"],
            "scrollX": true
            }).buttons().container().appendTo('#tblContents .col-md-6:eq(0)');
